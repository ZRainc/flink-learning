...
public class WordCountStreamDemo {
    public static void main(String[] args) throws Exception {
        ...
        // TODO 2. 读取数据：从文件中读取
        DataStreamSource<String> stringDataSource = executionEnvironment.readTextFile("/Users/zhangyuchen/IdeaProjects/flink-learning/flink-learning-examples/input/word.txt");

        // TODO 3. 数据处理：切分、转换、分组、聚合
        // TODO 3.1 切分、转换
        SingleOutputStreamOperator<Tuple2<String, Integer>> wordAndOneDS = stringDataSource
